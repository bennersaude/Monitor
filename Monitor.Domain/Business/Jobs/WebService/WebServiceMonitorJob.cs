...
{
    public class WebServiceMonitorJob : IMonitorJob
    {
        private const string TIMEOUT = "timeout";
        private const int MILLISECONDS_IN_SECOND = 1000;
        private static readonly ILog logger = LogManager.GetLogger(typeof(WebServiceMonitorJob));
        ...
        public WebServiceMonitorJob(ISessionProvider monitorSessionProvider,
            Ambiente ambiente,
        ...
        private void TestarConectividadeSistemas()
        {
            ...
            using (var monitorSession = monitorSessionProvider.OpenSession())
            {
                ...
                foreach (var sistema in sistemas)
                {
                    ...
                    {
                        logger.Error($"*** Falha ao testar conectividade para o ambiente {ambiente.Nome} e sistema {sistema.Nome}: {ex}");
                    }
                }
            }
        }
